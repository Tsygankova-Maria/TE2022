 ...
 */
    ...
    if(side == 2){  
     ...
     if(Global_hand == 0){
      diff= (dis_left - dis_left_b)/75*20;
      if(180-diff*75 > 0){
       Encoder_1.setMotorPwm(130-diff*75);
       Encoder_2.setMotorPwm(-130-diff*75);
      }
      else{
      ...
      if((dis_right+dis_right_b)/2 > 12){
       ...
       Encoder_2.setMotorPwm(-130*0.7);
      }
      else if((dis_right+dis_right_b)/2 < 7.5){
       Encoder_1.setMotorPwm(130*0.7);
      ...
      if(Global_hand == 0){
       if(dis_left > 25 ){
         if(dis_left_b > 25) gyro_rotate(0);
          ...
          Encoder_1.setTarPWM(180);
          Encoder_2.setTarPWM(-180);          
         }
        }
        else if(dis_front < 18){
         gyro_rotate(1);
        }
        else{
         gyro_rotate(2);
